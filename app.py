...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Văn Nguyên - Trường Tiểu học Phương Độ - ĐT: 0941445926</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Văn Nguyên - Trường Tiểu học Phương Độ - ĐT: 0941445926</div>", unsafe_allow_html=True)
